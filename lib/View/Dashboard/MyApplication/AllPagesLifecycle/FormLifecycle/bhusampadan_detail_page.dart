...
class BhusampadanDetailPage extends StatelessWidget {
  const BhusampadanDetailPage({super.key});
  ...
  Widget _buildHeader(double sizeFactor, BhusampadanForm form) {
    return Container(
  ...
  Widget _buildStatusBadgeWhite(double sizeFactor, BhusampadanForm form) {
    return Container(
  ...
  Widget _buildPreviewBanner(double sizeFactor, BhusampadanForm form) {
  ...
  void _showFormPreviewBottomSheet(BhusampadanForm form) {
    Get.bottomSheet(
  ...
  Widget _buildFormPreviewBottomSheet(BhusampadanForm form) {
    final sizeFactor = 0.85;
  ...
  Widget _buildStatusBadge(BhusampadanForm form, double sizeFactor) {
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: 10.w * sizeFactor,
        vertical: 4.h * sizeFactor,
      ...
      children: [
        Wrap(
          ...
          children: documents.asMap().entries.map((entry) {
            ...
            return GestureDetector(
              onTap: () {
                final allPaths = documents.map((d) => d['path'] as String).toList();
