...
class ApiService {
  ...
  static void _logSuccess(int statusCode, dynamic response) {
    if (kDebugMode) {
      developer.log('┌───────────────────────────────────────────────────');
      developer.log('│ ✅ API CALL SUCCESSFUL: Status $statusCode');
      developer.log('└───────────────────────────────────────────────────');
    }
  }
  ...
  static void _logError(String operation, Uri? url, String message,
    ...
    if (kDebugMode) {
      developer.log('┌───────────────────────────────────────────────────');
      developer.log('│ ❌ API ERROR: $operation ${url?.toString() ?? ''}');
      if (statusCode != null) {
        developer.log('│ 🔢 STATUS CODE: $statusCode');
      }
      developer.log('│ 🚨 ERROR MESSAGE: $message');
      developer.log('└───────────────────────────────────────────────────');
    }
  }
